...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			double timeStart = (double)System.nanoTime()/bln;
			Document doc = new BasicDocument(str);
			double score = doc.getFleschScore();
			double timeFinish = (double)System.nanoTime()/bln;
			System.out.print(timeFinish-timeStart + "\t");

			timeStart = (double)System.nanoTime()/bln;
			doc = new EfficientDocument(str);
			score = doc.getFleschScore();
			timeFinish = (double)System.nanoTime()/bln;
